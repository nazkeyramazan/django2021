...
from api.managers import BookManager , PublisherManager , BookDetailManager
...
class BookCategory(models.Model):
    name = models.CharField(verbose_name='Book category name' , max_length=255 , unique=True),
...
class Book(models.Model):
    name = models.ForeignKey(MainCategory , on_delete=models.RESTRICT,  verbose_name="Book name"  )
    description = models.TextField(max_length=10000,default="No data")
